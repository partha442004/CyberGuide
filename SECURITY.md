...
If you discover a security vulnerability within CyberGuide, please send an email to ravi.kumar@example.com. All security vulnerabilities will be promptly addressed.
...
- **Security Email**: ravi.kumar@example.com
