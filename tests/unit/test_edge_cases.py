...
class TestHackerNewsEdgeCases:
    ...
    async def test_fetch_returns_jobs(self):
        ...
        scraper._get_thread_comments = AsyncMock(return_value=[
            {"id": 1, "text": "TechCorp | Python Dev | Remote<p>Build APIs", "time": 1700000000},
    ...
    async def test_get_thread_comments(self):
        ...
        scraper._get = AsyncMock(side_effect=[story_response, comment1, comment2, comment3])
    ...
    def test_parse_comment_html_in_text(self):
        from interntrack.scrapers.hackernews import HackerNewsScraper
        scraper = HackerNewsScraper()
        comment = {"id": 1, "text": "TechCorp | Python Dev<p>Build APIs", "time": 1700000000}
...
class TestLinkedInEdgeCases:
    ...
    def test_parse_job_card_valid(self):
        ...
        card.find.side_effect = [
            title_elem, company_elem, link_elem, location_elem, date_elem, desc_elem
        ]
...
class TestIndeedEdgeCases:
    ...
    def test_parse_job_card_with_salary(self):
        ...
        card.find.side_effect = [
            title_elem, company_elem, link_elem, location_elem, salary_elem, snippet_elem
        ]
        card.find.side_effect = [
            lambda *a, **kw: title_elem,
            lambda *a, **kw: company_elem,
            lambda *a, **kw: link_elem,
            lambda *a, **kw: location_elem,
            lambda *a, **kw: salary_elem,
            lambda *a, **kw: snippet_elem,
        ]
    ...
    async def test_fetch_feed_with_entries(self):
        ...
        with patch("interntrack.scrapers.rss_feeds.feedparser") as mock_feed:
            mock_feed.parse.return_value.entries = [
                {"title": "Python Dev", "link": "https://example.com", "summary": "Python role"},
            ]
...
class TestWorkerEdgeCases:
    ...
    async def test_worker_main_with_signal(self):
        ...
        with (
            ...
            patch("interntrack.worker.signal") as mock_signal,
