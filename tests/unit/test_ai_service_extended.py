"""Extended unit tests for services/ai_service.py — covers Ollama, recommendations, rules."""
...
class TestAIServiceClassifyWithOllama:
    ...
    def _make_ollama_mock(self, status_code=200, response_json=None):
        ...
        if response_json is None:
            response_json = {"response": '{"job_type": "internship", "confidence": 0.7}'}
...
class TestAIServiceSkillRecommendations:
    ...
    async def test_get_recommendations_multiple_skills(self):
        ...
        result = await service._get_skill_recommendations(["python", "docker", "kubernetes"])
