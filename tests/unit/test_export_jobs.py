...
class TestExportJobs:
    ...
    async def test_export_csv_success(self, tmp_path):
        ...
        with (
            ...
            result = await export_jobs(output_file=output, file_format="csv")
    ...
    async def test_export_json_success(self, tmp_path):
        ...
        with (
            ...
            result = await export_jobs(output_file=output, file_format="json")
    ...
    async def test_export_no_jobs(self):
        ...
        with (
            ...
            result = await export_jobs(file_format="csv")
    ...
    async def test_export_unsupported_format(self, tmp_path):
        ...
        with (
            ...
            result = await export_jobs(output_file=output, file_format="xml")
    ...
    async def test_export_with_limit(self, tmp_path):
        ...
        with (
            ...
            result = await export_jobs(output_file=output, file_format="csv", limit=5)
