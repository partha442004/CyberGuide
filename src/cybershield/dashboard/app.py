...
def show_overview():
    ...
    import pandas as pd
    df = pd.DataFrame({
        "Title": ["Security Analyst", "SOC Engineer", "Penetration Tester", "Cloud Security Engineer", "Incident Response Analyst"],
        "Company": ["Microsoft", "Google", "Amazon", "Cisco", "CrowdStrike"],
        "Location": ["Redmond, WA", "Mountain View, CA", "Seattle, WA", "San Jose, CA", "Remote"],
...
def show_applications():
    ...
    for app in applications:
        ...
        with col3:
            st.selectbox("Status", ["Saved", "Applied", "Interview", "Assessment", "Rejected", "Offer"],
                        index=["Saved", "Applied", "Interview", "Assessment", "Rejected", "Offer"].index(app['status']),
...
def show_settings():
    ...
    col1, col2, col3 = st.columns(3)
    with col1:
        st.multiselect("Target Roles", ["SOC Analyst", "Security Engineer", "Penetration Tester"], default=["SOC Analyst"])
    with col2:
