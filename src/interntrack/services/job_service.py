...
_AUTO_TAG_KEYWORDS: tuple[str, ...] = (
    ...
    "css",
    "figma",
    # Hardware / electronics / embedded roles (hardware domain members:
    # PCB, embedded, RF, VLSI, test engineers). These jobs carried zero
    # tags before, so they scored match % null against hardware resumes.
    "pcb",
    "pcb design",
    "schematic",
    "circuit",
